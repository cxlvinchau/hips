...
only the trivially roundable variables (refer to :meth:`hips.models._mip_model.trivially_roundable`). In HIPS the :class:`hips.heuristics.SimpleRounding` class implements the **Simple Rounding** heuristic.
