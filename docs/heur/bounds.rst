...
There are 3 ways to use this heuristic, represent by the values of :class:`hips.heuristics.BoundDirection`.
In the cases :ref:`LOWER <src/hips/heuristics/_bounds.py:14>` or :ref:`UPPER <src/hips/heuristics/_bounds.py:15>`, every integer variable is fixed to their respective lower or upper bound respectibely.
