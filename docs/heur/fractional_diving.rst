...
.. math::
        \mathbf{if} \qquad x_j - \lfloor x_j \rfloor \le \lceil x_j \rceil - x_j\\
        \mathbf{then} \qquad upper\_bound(x_j) \leftarrow \lfloor x_j \rfloor\\
        \mathbf{else} \quad lower\_bound(x_j) \leftarrow \lceil x_j \rceil
